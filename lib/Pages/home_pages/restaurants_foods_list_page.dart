...
class RestaurantFoodsListPage extends StatefulWidget {
  final int currentRestaurant;
  RestaurantFoodsListPage(this.currentRestaurant);

  @override
  _RestaurantFoodsListPageState createState() =>
      _RestaurantFoodsListPageState();
}

class _RestaurantFoodsListPageState extends State<RestaurantFoodsListPage> {
  ...
  Widget build(BuildContext context) {
      ...
      return TextButton(
        onPressed: () {
          Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      RestaurantFoodDetailPage(currentRestaurant, food)));
        },
    ...
    return ListView(children: [searching(), chooseType(), building()]);
  }
}
